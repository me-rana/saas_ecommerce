                ...
                <form action="{{ url('product/store') }}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                      ...
                      <input type="text" name="product_code" id="" class="form-control" placeholder="" value="BD-{{ str_pad($serial_id+1, 4, '0', STR_PAD_LEFT); }}" aria-describedby="helpId" />
                  </div>
                  ...
                  <div class="mb-3 col-md-6">
                    ...
                    <div class="mb-3 col-md-3">
                      ...
                      <input type="number" name="quantity" value="{{old('quantity') ?? ''}}" id="" class="form-control" placeholder="" aria-describedby="helpId" />
                  </div>

                  <div class="mb-3 col-md-3">
                    <label for="" class="form-label">Purchase Price</label>
                    <input type="number" name="purchase_price" value="{{old('purchase_price') ?? ''}}" id="" class="form-control" placeholder="" aria-describedby="helpId" />
                  </div>
                  <div class="mb-3 col-md-3">
                    <label for="" class="form-label">Old Price</label>
                    <input type="number" name="old_price" value="{{old('old_price') ?? ''}}" id="" class="form-control" placeholder="" aria-describedby="helpId" />
                  </div>
                  <div class="mb-3 col-md-3">
                    <label for="" class="form-label">Sale Price</label>
                    <input type="number" name="sale_price" value="{{old('sale_price') ?? ''}}" id="" class="form-control" placeholder="" aria-describedby="helpId" />
                  </div>
                  ...
                  <div class="mb-3 col-md-12">
                    ...
                    <textarea class="form-control" name="description" id="#inp_editor1" rows="3">{{old('description') ?? ''}}</textarea>
                  </div>
